...
from lerobot.umi.shared_memory.shared_memory_queue import SharedMemoryQueue, Empty
from lerobot.umi.shared_memory.shared_memory_ring_buffer import SharedMemoryRingBuffer
from lerobot.umi.common.pose_trajectory_interpolator import PoseTrajectoryInterpolator
...
class FlexivInterface:
    ...
    def __init__(self, robot_ip, local_ip, move_home=True, init_offset=None, init_qpos=None, use_gripper_width_mapping=False, device="cuda"):
        global _flexiv_lock
    ...
    def get_ee_pose(self):
        """Now exclusively returns the Flange pose (EEF) for pure flange control."""
