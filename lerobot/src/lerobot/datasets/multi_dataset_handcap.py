...
class MultiLeRobotDatasetHandcap(torch.utils.data.Dataset):
    """A dataset consisting of multiple underlying `LeRobotDatasetHandcap`s.

    The underlying `LeRobotDatasetHandcap`s are effectively concatenated, and this class adopts much of the API
    structure of `LeRobotDatasetHandcap`.
    """
