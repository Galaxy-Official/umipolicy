...
def control_loop(
    ...
    while timestamp < control_time_s:
        ...
        if display_cameras and not is_headless():
            ...
            positions = {
                "observation.images.head": (0, 0),         # top right
                "observation.images.side": (0, 520),         # bottom left
                "observation.images.wrist": (600, 520),     # bottom right
                "observation.images.left_tactile": (1200, 520),   # top left
                "observation.images.right_tactile": (1200, 0)  # top right
            }
