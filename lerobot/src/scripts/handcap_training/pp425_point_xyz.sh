...
OUTPUT_DIR="outputs/train/pp425_point_xyz"
...
accelerate launch \
  ...
  --dataset.root=/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/lihong_workspace/lihong/umipolicy/lerobot/src/Data/pp425 \
  ...
  --save_freq=5000 \
  --resume=true \
  --config_path=/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/lihong_workspace/lihong/umipolicy/lerobot/src/outputs/train/pp425_point_xyz/checkpoints/last/pretrained_model/train_config.json \
