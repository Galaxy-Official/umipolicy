...
@BaseTask.register_task("eat_fruit")
class EatFruit(BaseTask):
    ...
    def draw_causal_graph(self, attr_prob_dict, aff_prob_dict):
            ...
            if len(pos_attribute_names) % 2 == 0:
                fig.add_trace(
                    go.Scatter(
                        ...
                        textfont=dict(color="#FFB200", size=20, weight="bold"),
                    ),
                )
            else:
                fig.add_trace(
            ...
            if len(neg_attribute_names) % 2 == 0:
                fig.add_trace(
                    go.Scatter(
                        ...
                        text=["-"],
                        textposition="middle center",
                        textfont=dict(color="#EB5B00", size=20, weight="bold"),
                    ),
                )
            else:
                fig.add_trace(
        ...
        img = fig.to_image(format="png", scale=9)
