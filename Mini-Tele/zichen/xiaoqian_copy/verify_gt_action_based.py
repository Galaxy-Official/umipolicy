...
def main():
    """主验证函数"""
    print("=== Ground Truth Trajectory Verification (Action-Based) ===")
    ...
    try:
        ...
        gt_data = load_pickle('pred_keypoints/capture_0301/box/view_000_pose_000/gt_keypoints_action_based.pkl')
