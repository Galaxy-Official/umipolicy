...
## 640x360
# 233722071807: 
# [[455.06164551   0.         324.75561523]
#  [  0.         454.41860962 184.64910889]
#  [  0.           0.           1.        ]]

# 001622071104:
# [[457.10559082   0.         320.50961304]
#  [  0.         456.51031494 182.03712463]
#  [  0.           0.           1.        ]]

if __name__ == "__main__":

    # 视频保存路径
    calib_group = "collect_data/data/d3fields/2025-06-26-21"
    view_id = 0
    pos_id = 0
    ...
    while True:
        ...
        global_key = f"camera_{camera_id}"
        root_path = f"{calib_group}/{global_key}"
