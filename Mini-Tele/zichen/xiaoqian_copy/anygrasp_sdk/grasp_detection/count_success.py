...
SR_m = json.load(open("/Disk3/xiaoqian/pred_keypoints/capture_0301/SR_m.json", "r"))
SR_p = json.load(open("/Disk3/xiaoqian/pred_keypoints/capture_0301/SR_p_new.json", "r"))
