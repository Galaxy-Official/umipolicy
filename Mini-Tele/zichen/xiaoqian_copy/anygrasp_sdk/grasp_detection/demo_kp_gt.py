...
kp_axis1, kp_axis2, kp_contact = gt_keypoints["kp_axis1"], gt_keypoints["kp_axis2"], gt_keypoints["kp_contact"]
kp_axis1 = np.array(kp_axis1)
kp_axis2 = np.array(kp_axis2)
kp_contact = np.array(kp_contact)
pred_joint_directions = kp_axis2 - kp_axis1
pred_anchor_points = kp_axis1
...
# + 0.5 * to_axis_distance_scores # 1:4:2
