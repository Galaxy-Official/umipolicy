...
def _solve_ik_jax(
    ...
    factors = [
        pk.costs.pose_cost_analytic_jac(
            ...
            target_link_index,
            pos_weight=100.0,  # Increased for better position accuracy
            ori_weight=100.0,  # Increased to prevent 180-degree orientation flips
        ),
        pk.costs.limit_cost(
            robot,
            joint_var,
            weight=10.0,  # Reduced to prioritize pose accuracy over joint limits
        ),
    ]
    sol = (
