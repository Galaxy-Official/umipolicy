#!/usr/bin/env python3
"""
Automatic demonstration of the updated planning functionality.
Shows both OMPL (when available) and RRT planners in action without user input.
"""
...
def auto_demo_planning():
    """Automatic demonstration of both OMPL and RRT planners with visualization"""
    print("=== Automatic Planning Integration Demo ===")
    print("This demo shows both OMPL and RRT planners working with the Rizon4 robot")
    print("(Running automatically without user input)")
    ...
    try:
        ...
        # Pause briefly to let user see the setup
        print("   Setting up visualization...")
        for _ in range(50):  # 2 seconds at 25Hz
            p.stepSimulation()
            time.sleep(0.04)
        ...
        # Keep the visualization open for a few seconds
        print("\nVisualization will close automatically in 5 seconds...")
        for _ in range(125):  # 5 seconds at 25Hz
            p.stepSimulation()
            time.sleep(0.04)
...
def show_usage_examples():
    ...
    print("The demo shows the planning functionality without hardware dependencies.")

def main():
    """Main demo function"""
    print("Starting automatic planning integration demo...")

    # Show usage examples first
    show_usage_examples()

    print("\n" + "="*60)
    print("Starting automatic demo in 2 seconds...")
    time.sleep(2)

    # Run the automatic demo
    success = auto_demo_planning()
