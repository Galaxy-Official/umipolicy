...
from dataset.lerobot_latent_dataset_handcap import MultiLatentLeRobotDatasetHandcap
import gc
...
class Trainer:
    def __init__(self, config):
        ...
        train_dataset = MultiLatentLeRobotDatasetHandcap(config=config)
