...
CONFIG_NAME="${CONFIG_NAME:-handcap}"
...
LINGBOT_NUM_INFERENCE_STEPS="${LINGBOT_NUM_INFERENCE_STEPS:-}"
LINGBOT_ACTION_NUM_INFERENCE_STEPS="${LINGBOT_ACTION_NUM_INFERENCE_STEPS:-}"
