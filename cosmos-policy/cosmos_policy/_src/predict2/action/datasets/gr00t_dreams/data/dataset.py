...
from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.data.embodiment_tags import EmbodimentTag
from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.data.schema import (
    DatasetMetadata,
...
# from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.data.transform. import ComposedModalityTransform
from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.data.transform.base import ComposedModalityTransform
from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.utils.video import (
    get_all_frames,
    get_frames_by_timestamps,
)

# from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.groot_configs import construct_modality_config_and_transforms
...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        from cosmos_policy._src.predict2.action.datasets.gr00t_dreams.groot_configs import (
