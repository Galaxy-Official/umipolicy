...
class StreamingLeRobotDatasetHandcap(torch.utils.data.IterableDataset):
    ...
    Example:
        Basic usage:
        ```python
        from lerobot.common.datasets.streaming_dataset import StreamingLeRobotDatasetHandcap
    ...
    def __init__(
        ...
        """Initialize a StreamingLeRobotDatasetHandcap.
        ...
        # Load metadata
        self.meta = LeRobotDatasetMetadataHandcap(
