...
CONFIG_NAME="${CONFIG_NAME:-pi05_506_open_bottle_joint_tactile_force_predict}"
EXP_NAME="${EXP_NAME:-506_open_bottle_joint_handcap_pi05_4gpu_tactile_force_predict}"
