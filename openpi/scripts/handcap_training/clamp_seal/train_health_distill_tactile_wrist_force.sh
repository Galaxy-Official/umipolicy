...
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/clamp_seal_lerobot_multihealth}"
HEALTH0_DATA_ROOT="${HEALTH0_DATA_ROOT:-${DATA_ROOT_BASE}/clamp_seal_lerobot_health0}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/clamp_seal_lerobot_health50}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/clamp_seal_lerobot_health100}"
...
HEALTH_REPO_IDS=(
  "clamp_seal_lerobot_health0"
  "clamp_seal_lerobot_health50"
  "clamp_seal_lerobot_health100"
)
