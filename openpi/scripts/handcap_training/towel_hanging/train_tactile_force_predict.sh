...
CONFIG_NAME="${CONFIG_NAME:-pi05_430_towel_hanging_tactile_force_predict}"
EXP_NAME="${EXP_NAME:-towel_hanging_handcap_pi05_4gpu_tactile_force_predict}"
...
echo "Dataset: Data/towel_hanging_lerobot"
