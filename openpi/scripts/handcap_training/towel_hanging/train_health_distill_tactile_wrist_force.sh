...
CONFIG_NAME="${CONFIG_NAME:-pi05_430_towel_hanging_health_distill_tactile_wrist_force}"
EXP_NAME="${EXP_NAME:-towel_hanging_multihealth_pi05_health_distill_tactile_wrist_force}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"

# Relative to the openpi repo root after the cd above.
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/towel_hanging_lerobot_multihealth}"
HEALTH0_DATA_ROOT="${HEALTH0_DATA_ROOT:-${DATA_ROOT_BASE}/towel_hanging_lerobot_health0}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/towel_hanging_lerobot_health50}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/towel_hanging_lerobot_health100}"
...
HEALTH_REPO_IDS=(
  "towel_hanging_lerobot_health0"
  "towel_hanging_lerobot_health50"
  "towel_hanging_lerobot_health100"
)
