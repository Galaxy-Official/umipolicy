...
CONFIG_NAME="${CONFIG_NAME:-pi05_501_bread_moving_raw_200}"
EXP_NAME="${EXP_NAME:-501_bread_moving_raw_200_handcap_pi05_4gpu_vision_only}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"
DATA_ROOT="${DATA_ROOT:-Data/501_bread_moving_raw_lerobot_200}"
