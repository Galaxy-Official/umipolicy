...
CONFIG_NAME="${CONFIG_NAME:-pi05_512_close_bottle_health_distill_tactile_wrist_force}"
EXP_NAME="${EXP_NAME:-512_close_bottle_multihealth_pi05_health_distill_tactile_wrist_force}"

# Relative to the openpi repo root after the cd above.
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/512_close_bottle_lerobot_multihealth}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/512_close_bottle_lerobot_health50}"
HEALTH75_DATA_ROOT="${HEALTH75_DATA_ROOT:-${DATA_ROOT_BASE}/512_close_bottle_lerobot_health75}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/512_close_bottle_lerobot_health100_1}"
...
HEALTH_REPO_IDS=(
  "512_close_bottle_lerobot_health50"
  "512_close_bottle_lerobot_health75"
  "512_close_bottle_lerobot_health100_1"
)
