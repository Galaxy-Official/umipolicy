...
CONFIG_NAME="${CONFIG_NAME:-pi05_516_stowing_210_tactile}"
EXP_NAME="${EXP_NAME:-516_stowing_210_handcap_pi05_4gpu_vision_tactile}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"
DATA_ROOT="${DATA_ROOT:-Data/516_stowing_lerobot_210}"
