...
CONFIG_NAME="${CONFIG_NAME:-pi05_505_screw_health_distill_tactile_wrist_force}"
EXP_NAME="${EXP_NAME:-509_screw_multihealth_pi05_health_distill_tactile_wrist_force}"
DATA_REPO_ID="${DATA_REPO_ID:-509_screw_health_distill}"

# Relative to the openpi repo root after the cd above.
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/509_screw_lerobot_multihealth}"
HEALTH0_DATA_ROOT="${HEALTH0_DATA_ROOT:-${DATA_ROOT_BASE}/509_screw_lerobot_health0}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/509_screw_lerobot_health50}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/509_screw_lerobot_health100}"
...
HEALTH_REPO_IDS=(
  "509_screw_lerobot_health0"
  "509_screw_lerobot_health50"
  "509_screw_lerobot_health100"
)
...
echo "=========================================="
echo "Starting OpenPI PI05 screw multi-health distillation training"
