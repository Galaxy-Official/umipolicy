...
CONFIG_NAME="${CONFIG_NAME:-pi05_510_erase_board_350_action16}"
EXP_NAME="${EXP_NAME:-510_erase_board_350_handcap_pi05_4gpu_vision_only_action16}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"
DATA_ROOT="${DATA_ROOT:-Data/510_erase_board_350_lerobot}"
