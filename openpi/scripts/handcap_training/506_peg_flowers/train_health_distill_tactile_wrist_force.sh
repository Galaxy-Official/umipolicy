...
CONFIG_NAME="${CONFIG_NAME:-pi05_506_peg_flowers_health_distill_tactile_wrist_force}"
EXP_NAME="${EXP_NAME:-509_peg_flowers_multihealth_pi05_health_distill_tactile_wrist_force}"
DATA_REPO_ID="${DATA_REPO_ID:-509_peg_flowers_health_distill}"

# Relative to the openpi repo root after the cd above.
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/509_peg_flowers_lerobot_multihealth}"
HEALTH0_DATA_ROOT="${HEALTH0_DATA_ROOT:-${DATA_ROOT_BASE}/509_peg_flowers_lerobot_health0}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/509_peg_flowers_lerobot_health50}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/509_peg_flowers_lerobot_health100}"
...
HEALTH_REPO_IDS=(
  "509_peg_flowers_lerobot_health0"
  "509_peg_flowers_lerobot_health50"
  "509_peg_flowers_lerobot_health100"
)
...
# This workload is video-decode bound; keep enough workers to avoid starving the GPUs.
...
echo "=========================================="
echo "Starting OpenPI PI05 peg flowers multi-health distillation training"
echo "Config: ${CONFIG_NAME}"
echo "Experiment: ${EXP_NAME}"
echo "Data repo id: ${DATA_REPO_ID}"
