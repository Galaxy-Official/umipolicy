...
CONFIG_NAME="${CONFIG_NAME:-pi05_erase_board_wrist_tactile_concat_t3}"
EXP_NAME="${EXP_NAME:-erase_board_handcap_pi05_4gpu_tactile_concat_t3}"
DATA_ROOT="${DATA_ROOT:-Data/erase_board_lerobot}"
