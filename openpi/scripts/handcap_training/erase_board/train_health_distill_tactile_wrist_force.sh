...
CONFIG_NAME="${CONFIG_NAME:-pi05_erase_board_wrist_health_distill_tactile_wrist_force}"
...
DATA_ROOT_BASE="${DATA_ROOT_BASE:-Data/erase_board_lerobot_multihealth}"
HEALTH0_DATA_ROOT="${HEALTH0_DATA_ROOT:-${DATA_ROOT_BASE}/erase_board_lerobot_health0}"
HEALTH50_DATA_ROOT="${HEALTH50_DATA_ROOT:-${DATA_ROOT_BASE}/erase_board_lerobot_health50}"
HEALTH100_DATA_ROOT="${HEALTH100_DATA_ROOT:-${DATA_ROOT_BASE}/erase_board_lerobot_health100}"
...
HEALTH_REPO_IDS=(
  "erase_board_lerobot_health0"
  "erase_board_lerobot_health50"
  "erase_board_lerobot_health100"
)
