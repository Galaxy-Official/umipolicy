...
CONFIG_NAME="${CONFIG_NAME:-pi05_427_yellow_to_pink_200}"
EXP_NAME="${EXP_NAME:-427_yellow_to_pink_200_handcap_pi05_4gpu_vision_only}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"
DATA_ROOT="${DATA_ROOT:-Data/427_yellow_to_pink_lerobot_200}"
