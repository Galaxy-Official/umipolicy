...
CONFIG_NAME="${CONFIG_NAME:-pi05_513_screw_490_tactile_concat_t3}"
EXP_NAME="${EXP_NAME:-513_screw_490_handcap_pi05_4gpu_tactile_concat_t3}"
export WANDB_DIR="${WANDB_DIR:-checkpoints/${CONFIG_NAME}/${EXP_NAME}}"
DATA_ROOT="${DATA_ROOT:-Data/513_screw_lerobot_490}"
