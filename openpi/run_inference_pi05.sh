...
# export FLEXIV_INIT_POSE="${FLEXIV_INIT_POSE:-[0.1601,0.0985,-0.0368,2.0673,-0.1229,0.5877,0.2794]}"
...
# export FLEXIV_INIT_POSE="${FLEXIV_INIT_POSE:-[0.0271,-0.1843,-0.0284,1.7536,-0.0399,0.4840,0.0729]}"
export FLEXIV_INIT_POSE="${FLEXIV_INIT_POSE:-[0.1197,0.1406,-0.0135,2.0773,-0.0748,0.4030,0.1470]}"
...
# POLICY_CONFIG="${POLICY_CONFIG:-pi05_516_stowing_210}"

# # 4. 策略权重路径（保存模型的 ckpt 文件夹相对路径）
# POLICY_DIR="${POLICY_DIR:-ckpt/lihong/516_stowing_210_vision_20000}"

# # 5. 任务 Prompt 提示词（输入给模型的语言指令）
# PROMPT="${PROMPT:-Sequentially move the yellow rectangular block, the orange box, and the yellow trapezoidal block into the paper box.}"
...
export FLEXIV_USE_DIRECT_EEF="0" # 置为1以跳过法兰到TCP转换，强制发送直接EEF指令（测试用）
