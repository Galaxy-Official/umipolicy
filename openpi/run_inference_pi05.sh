...
POLICY_CONFIG="${POLICY_CONFIG:-pi05_506_peg_flowers}"

# 4. 策略权重路径（保存模型的 ckpt 文件夹相对路径）
POLICY_DIR="${POLICY_DIR:-ckpt/lihong/506_peg_flowers_vision_70000}"

# 5. 任务 Prompt 提示词（输入给模型的语言指令）
PROMPT="${PROMPT:-pick up the flower and insert it into the red vase.}"
# ==============================================================================
...
export FLEXIV_INIT_POSE="${FLEXIV_INIT_POSE:-[-0.0009,-0.4287,-0.0133,1.5859,-0.0058,0.4814,-0.0012]}"
